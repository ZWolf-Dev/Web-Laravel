<header class="header">
    <div class="grid wide">
        <nav class="header__navbar hide-on-mobile-tablet">
            <ul class="header__navbar-list">
                <li class="header__navbar-item header__navbar-item--has-qr header__navbar-item--separate">
                    Vào cửa hàng trên ứng dụng Tiktok

                    <!-- Header QR Code -->
                    <div class="header__qr">
                        <img src="{{ asset('img/qr_tiktok_shopee.png') }}" alt="QR code" class="header__qr-img">
                        <div class="header__qr-apps">
                            <a href="#" class="header__qr-link">
                                <img src="{{ asset('img/app_store.png') }}" alt="App Store" class="header__qr-download-img">
                            </a>
                            <a href="#" class="header__qr-link">
                                <img src="{{ asset('img/google_play.png') }}" alt="Google Play" class="header__qr-download-img">
                            </a>
                        </div>
                    </div>
                </li>
                                ...
                                <li class="header__notify-item header__notify-item--viewed">
                                    <a href="#" class="header__notify-link">
                                        ...
                                        <div class="header__notify-info">
                                            <span class="header__notify-name">🎁 Tặng ltchinh098406 01 Mã
                                                Freeship!</span>
        ...
        <input type="checkbox" hidden class="header__mobile-navbar-checkbox" id="header-mobile-navbar-checkbox">

        <!-- Mobile user menu -->
        <nav class="header__mobile-navbar">
            <label for="header-mobile-navbar-checkbox" class="header__mobile-navbar-close">
            ...
            <ul class="header__mobile-navbar-list">
                ...
                <li class="header__mobile-navbar-item">
                    <a class="header__mobile-navbar-link" href="#">Địa chỉ của tôi</a>
                </li>
                <li class="header__mobile-navbar-item">
        ...
        <!-- Overlay -->
        <label for="header-mobile-navbar-checkbox" class="nav__overlay">

        </label>
        
        <!-- header-with-search -->
        <div class="header-with-search">              
            <label for="mobile-search-checkbox" class="header__mobile-search l-0">
                <label for="header-mobile-navbar-checkbox" class="header__mobile-user-list">
                    <i class="header__mobile-user-list-icon fa-solid fa-address-book"></i>
                </label>
            ...
            <div class="header__search">
                <div class="header__search-wrap">
                    <input type="text" class="header__search-wrap-input" placeholder="Tìm kiếm sản phẩm">
            ...
            <div class="header__cart">
                <div class="header__cart-wrap">
                    ...
                    <span class="header__cart-notive">3</span>
                    
                    <!-- No cart: header__cart-list--no-cart -->
                    <div class="header__cart-list">
                        <img src="{{ asset('img/no_card.png" alt="" class="header__cart-no-cart-img') }}">
                        
                        <h4 class="header__cart-heading">Sản phẩm đã thêm</h4>
                        <ul class="header__cart-list-item">
                            <!-- Cart item -->
                            <li class="header__cart-item">
                                <img src="https://cf.shopee.vn/file/f9864891a8ba04e463d2dd446e745c49" class="header__cart-img" alt="">
                                <div class="header__cart-item-info">
                                    <div class="header__cart-item-head">
                                        <h5 class="header__cart-item-name">Bộ kem đặt trị vùng mắt</h5>
                            ...
                            <li class="header__cart-item">
                                <img src="https://cf.shopee.vn/file/c64ddf57f14037d07edc37f88c364641_tn" class="header__cart-img" alt="">
                                <div class="header__cart-item-info">
                                    <div class="header__cart-item-head">
                                        <h5 class="header__cart-item-name">Bộ kem đặt trị vùng mắt</h5>
                                        <div class="header__cart-item-price-wrap">
                            ...
                            <li class="header__cart-item">
                                <img src="https://cf.shopee.vn/file/2a4a9a695ba8e32e84d5c14da4fe785e_tn" class="header__cart-img" alt="">
                                <div class="header__cart-item-info">
                                    <div class="header__cart-item-head">
                                        <h5 class="header__cart-item-name">Bộ kem đặt trị vùng mắt</h5>
                                        <div class="header__cart-item-price-wrap">
